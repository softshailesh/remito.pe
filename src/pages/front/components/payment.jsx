  ...
  return (
    <section className="bg-white py-16 px-4 md:px-10 lg:px-20">
      ...
      <p className="text-center text-[#8c94a6] mb-12 text-sm md:text-base">
        Leverage the complexity of cross-border transactions for any kind of business
      </p>
        ...
        {data.map((item) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[rgba(29,52,88,0.4)] text-[48px] font-[700]">{item.id}</span>
            </div>
            ...
            <ul className="space-y-3 text-[#525F7F] leading-relaxed">
              {item.points.map((point, index) => (
                <li key={index} className="flex items-baseline gap-2">
                  <span className="text-[#EB5C26] text-2xl leading-[1]">•</span>
