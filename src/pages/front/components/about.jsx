        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
          ...
          <div className="text-left z-10">
            ...
            <p className="text-[#525F7F] text-[16px] md:text-base leading-relaxed mb-4 font-[400]">
              ...
              , we believe sending and receiving money across borders should be
              as simple as sending a message. It is a powerful, secure, and
              easy-to-use platform that makes global payments effortless for
              businesses and individuals alike.
            </p>

            <p className="text-[#525F7F] text-[16px] md:text-base leading-relaxed mb-4 font-[400]">
              Our mission is to remove the friction traditionally associated
              with international transactions—complex processes, high fees, and
              long delays. Whether you’re a small business expanding globally, a
              freelancer working with overseas clients, or an individual
              supporting family abroad, we provide a fast, secure, and
              cost-effective solution tailored to your needs.
            </p>

            <p className="text-[#525F7F] text-[16px] md:text-base leading-relaxed mb-4 font-[400]">
              We serve a wide range of industries including e-commerce, travel
              and tourism, freelancing, and import/export businesses. Backed by
              24/7 dedicated customer support, competitive exchange rates, and
            ...
            <ul className="space-y-2 text-[#0B153C] font-medium text-sm md:text-base">
              <li className="flex items-baseline gap-2">
                ...
                <span className=" text-[16px] font-[500] leading-none">
                  Secure and Trusted
                </span>
              </li>
