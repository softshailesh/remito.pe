...
// import { addEnquiry, resetEnquiryState } from "../../../store/slice/enquirySlice";
...
//     e.preventDefault();
//     const { name, email, mobileNumber, country, consent } = formData;
...
//     if (!consent) {
//       toast.warning("Please agree to be contacted before submitting.");
//       return;
//     }

//     const payload = {
//       ...formData,
//       type_of_service: selectedType,
//     };
...
//       <div className="w-full max-w-[1300px] bg-white rounded-2xl shadow-sm p-6 md:p-10 border border-gray-200">
...
//                 className={`px-5 py-2.5 rounded-full border text-sm font-medium transition ${selectedType === type
...
//               className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:ring-2 focus:ring-orange-500"
//             />
//           </div>
...
//                   onChange={handleChange}
//                   className="w-full  py-2.5 text-sm bg-white outline-none"
//                 >
//                   {countryCodes.map((country) => (
//                     <option key={country.iso} value={country.value}>
//                       {country.value}
//                     </option>
//                   ))}
//                 </select>
...
//               onChange={handleChange}
//               className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm bg-white focus:ring-2 focus:ring-orange-500 outline-none"
//             >
//               <option value="">Select Country</option>
//               {countryCodes.map((country) => (
//                 <option key={country.iso} value={country.label}>
//                   {country.label}
//                 </option>
//               ))}
//             </select>
...
//               onChange={handleChange}
//               className="w-full border border-gray-300 rounded-md px-3 py-2.5 text-sm focus:ring-2 focus:ring-orange-500 resize-none"
//             ></textarea>
//           </div>
...
const ContactForm = () => {
  ...
  const [formErrors, setFormErrors] = useState({}); // <-- store field-wise errors
  ...
  const validate = () => {
    ...
    else if (!/^[0-9]{6,15}$/.test(formData.mobileNumber))
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              value={formData.name}
              onChange={handleChange}
              className={`w-full border rounded-md px-3 py-2.5 text-sm focus:ring-2 ${
                formErrors.name
          ...
          <div>
            ...
            >
              <div className="flex items-center px-3 border-r border-gray-300 text-sm bg-gray-50">
                <select
                  name="country_code"
                  value={formData.country_code}
                  onChange={handleChange}
              ...
              <input
                ...
                value={formData.mobileNumber}
                onChange={handleChange}
                className="w-full px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
          ...
          <div>
            ...
            <select
              ...
              value={formData.country}
              onChange={handleChange}
              className={`w-full border rounded-md px-3 py-2.5 text-sm bg-white focus:ring-2 ${
                formErrors.country
                  ? "border-red-500 focus:ring-red-500"
                  : "border-gray-300 focus:ring-orange-500"
              }`}
